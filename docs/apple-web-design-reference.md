# Apple Web Design Reference

> Scope: This document is a design reference for `mecolette-legal` only. Do not apply these rules to the MECOLETTE iOS app unless a future task explicitly asks for it.
